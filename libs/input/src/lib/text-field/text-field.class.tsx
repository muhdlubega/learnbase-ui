...
export const textFieldStyles = cva('flex items-center transition-all cursor-pointer', {
  variants: {
    color: Colors,
    textSize: {
...
export const labelStyles = cva('absolute block max-w-[200px] overflow-hidden overflow-ellipsis p-0.5 text-xs', {
  variants: {
    disabled: {
